...
var (
	grpc_address = flag.String("grpc-addr", "localhost:8888", "this is address of grpc server that handles reg and login functions")
...
func main(){
	...
	err := pb.RegisterAuthHandlerFromEndpoint(ctx, mux, *grpc_address, opts)
	if err != nil{
