...
const (
	Auth_Registration_FullMethodName = "/protoauth.Auth/Registration"
	Auth_Login_FullMethodName        = "/protoauth.Auth/Login"
)
...
func (c *authClient) Registration(ctx context.Context, in *RegistrationRequest, opts ...grpc.CallOption) (*RegistrationReply, error) {
...
func (UnimplementedAuthServer) Registration(context.Context, *RegistrationRequest) (*RegistrationReply, error) {
...
const (
	Business_Hello_FullMethodName = "/protoauth.Business/Hello"
)
...
func (c *businessClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, Business_Hello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedBusinessServer
// for forward compatibility.
type BusinessServer interface {
	Hello(context.Context, *HelloRequest) (*HelloReply, error)
}

// UnimplementedBusinessServer should be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedBusinessServer) Hello(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _Business_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BusinessServer).Hello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Business_Hello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BusinessServer).Hello(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Business_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protoauth.Business",
	HandlerType: (*BusinessServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Hello",
			Handler:    _Business_Hello_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/auth_service.proto",
